...
propertyData <- merge(data, multiples, by="propdmgexp")
propertyData$propdmg_m <- as.numeric(propertyData$propdmg) * as.numeric(propertyData$propmultiple)
...
propertyData$cropdmg_m <- as.numeric(propertyData$cropdmg) * as.numeric(propertyData$cropmultiple)
